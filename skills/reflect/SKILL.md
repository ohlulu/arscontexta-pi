...
1. Try `qmd status` to get the indexed document count for the target collection
...
**Tier 1 — MCP tools (preferred):** Use `qmd dsearch` (hybrid search with expansion + reranking):
