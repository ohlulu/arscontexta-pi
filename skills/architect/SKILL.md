...
- Use `qmd dsearch` to find claims that address the specific friction
- Fall back to `qmd vsearch` if hybrid search is unavailable
...
```
qmd dsearch  query="[friction description in natural language]"  limit=10
```
