...
4. For each candidate:
   - Tier 1 (preferred): use `qmd vsearch` with query "[claim as sentence]", collection="{vocabulary.notes_collection}", limit=5
...
```
qmd vsearch  query="[proposed claim as sentence]"  collection="{vocabulary.notes_collection}"  limit=5
```
