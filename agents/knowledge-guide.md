...
1. **Read the methodology reference** — resolve from skill directory: `../../reference/methodology.md`
2. **Check the claim-map** — `../../reference/claim-map.md` for relevant research
